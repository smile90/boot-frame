...
public class SecurityException extends BaseRuntimeException {
    public static final String USERNAME_PWD_NOT_SUCC_CODE = SysConstants.PUBLIC_SYSTEM_CODE_AUTH + "0001";
    public static final String USERNAME_PWD_NOT_SUCC_MSG = "用户名或密码错误！";
    public static final String USER_ERROR_CODE = SysConstants.PUBLIC_SYSTEM_CODE_AUTH + "0002";
    public static final String USER_ERROR_MSG = "用户状态异常，请联系管理员！";
    public static final String USER_LOCKED_CODE = SysConstants.PUBLIC_SYSTEM_CODE_AUTH + "0003";
    public static final String USER_LOCKED_MSG = "用户状态异常，被锁定！";
    public static final String USER_DISABLED_CODE = SysConstants.PUBLIC_SYSTEM_CODE_AUTH + "0004";
    public static final String USER_DISABLED_MSG = "用户状态异常，被禁用！";
    public static final String USER_EXPIRED_CODE = SysConstants.PUBLIC_SYSTEM_CODE_AUTH + "0005";
